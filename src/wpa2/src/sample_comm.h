...
HI_S32 SAMPLE_COMM_VI_StopVi(SAMPLE_VI_MODE_E enViMode);
...
HI_S32 Sample_COMM_VENC_GetStreamStatus();
...
HI_S32 SAMPLE_COMM_VENC_StartEx(VENC_CHN VencChn, PAYLOAD_TYPE_E enType, VIDEO_NORM_E enNorm, PIC_SIZE_E enSize, SAMPLE_RC_E enRcMode, HI_U32  u32Profile, VENC_GOP_ATTR_S *pstGopAttr, uint32_t u32BitRate, uint16_t u16DstFrmRate);
